...
namespace Moryx.ClientFramework.Commands
{
    ...
    public sealed class CancelCommand : ICommand
    {
        ...
        /// Call <see cref="Reset"/> to reset the command to an uncancelled state.
        /// </summary>
        ...
        /// <summary>
        /// Resets this cancel command to an uncancelled state. If the cancel command hasn't executed yet, 
